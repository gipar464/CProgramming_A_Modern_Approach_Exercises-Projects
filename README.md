The following assumes you are on VSCode. 
...
To compile and run a c program, first make sure you have CLANG or GCC installed onto your system. first write the program to a .c file, then compile it (using gcc <filename.c> -o <whatevernameyouwant>.)
...
Challenging problems:
    1) 6programmingProject11.c (currently unsolved)
